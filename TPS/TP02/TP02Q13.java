...
/*
Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo Mergesort, fazendo com que a 
chave de pesquisa seja o atributo actorName. O nome do arquivo de log será matrícula_mergesort.txt.
 */
...
class TP02Q13 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Escrever os resultados no arquivo "matricula_mergesort.txt"
        try {
    ...
    public static void sort(Personagem vetor[], int n) {
    ...
    public static void merge(Personagem[] vetor, int esq, int meio, int dir) {
        int n1 = meio - esq + 1;
        int n2 = dir - meio;

        Personagem[] a1 = Arrays.copyOfRange(vetor, esq, esq + n1);
        Personagem[] a2 = Arrays.copyOfRange(vetor, meio + 1, meio + 1 + n2);
        ...
        while (i < n1 && j < n2) {
            ...
            if (a1[i].getActorName().compareTo(a2[j].getActorName()) < 0 ||
                    (a1[i].getActorName().equals(a2[j].getActorName())
